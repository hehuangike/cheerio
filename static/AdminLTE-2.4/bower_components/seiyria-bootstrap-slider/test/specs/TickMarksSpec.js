...
describe("Slider with ticks tests", function() {
	...
	it("Should reverse the tick labels if `reversed` option is set to true", function() {
		...
		var tickLabelsFromDOM = $("#testSlider1Ref .slider-tick-label-content")
	...
	it("Should reverse the tick labels if `reversed` option is set to true and `ticks_positions` is specified", function() {
		...
		// Assert that tick marks are reversed
		var tickLabelsFromDOM = $("#testSlider1Ref .slider-tick-label-content .slider-tick-label")
	...
	it("should wrap all of the ticks within a div with classname '.slider-tick-content'", function() {
		...
		// Assert that the ticks are children of the content element
		var numTicks = $sliderDOMRef.siblings('div.slider').find('.slider-tick-content > .slider-tick').length;
